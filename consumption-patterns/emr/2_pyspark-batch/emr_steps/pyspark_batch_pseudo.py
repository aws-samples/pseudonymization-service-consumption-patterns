...
"""
    ...
    Example usage: to do spark-submit --deploy-mode client s3://spark-batch-blogpost-443852570373/config/pyspark_batch_pseudo.py s3://spark-batch-blogpost-443852570373/config/pyspark_batch_config.YAML
"""
...
if __name__ == "__main__":
    ...
    if config:
        s3_table_path = f"s3://{config.output_bucket_name}/batch/warehouse/{config.db_name}/{config.table_name}"
