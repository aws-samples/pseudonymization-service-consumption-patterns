...
OPTIONS_FOUND=0
ICEBERG_DYNAMO_CHECKPOINT_TABLE_NAME="blogBatchGlueLockTable"
GLUE_DATABASE_NAME="blog_batch_db"
...
aws s3 rm s3://${ARTIFACT_BUCKET}/pyspark_batch_pseudo.py
aws s3 rm s3://${ARTIFACT_BUCKET}/pyspark_batch_config.yaml
